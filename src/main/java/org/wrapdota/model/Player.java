...
public class Player {
    ...
    public boolean equals(Object o) {
        ...
        if (denies != null ? !denies.equals(player.denies) : player.denies != null) return false;
        if (heroDamage != null ? !heroDamage.equals(player.heroDamage) : player.heroDamage != null) return false;
        if (heroHealing != null ? !heroHealing.equals(player.heroHealing) : player.heroHealing != null) return false;
        if (itemAndSlots != null ? !itemAndSlots.equals(player.itemAndSlots) : player.itemAndSlots != null)
            return false;
        if (lastHits != null ? !lastHits.equals(player.lastHits) : player.lastHits != null) return false;
        ...
        if (playerLastHitDetails != null ? !playerLastHitDetails.equals(player.playerLastHitDetails) : player.playerLastHitDetails != null)
            return false;
        if (towerDamage != null ? !towerDamage.equals(player.towerDamage) : player.towerDamage != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (heroDamage != null ? heroDamage.hashCode() : 0);
        result = 31 * result + (towerDamage != null ? towerDamage.hashCode() : 0);
        result = 31 * result + (heroHealing != null ? heroHealing.hashCode() : 0);
        result = 31 * result + (denies != null ? denies.hashCode() : 0);
        result = 31 * result + (lastHits != null ? lastHits.hashCode() : 0);
